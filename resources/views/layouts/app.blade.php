...
<html lang="en">
<head>
    <title>{{ isset($meta_title) ? 'কোড বন্ধু- '.$meta_title : 'কোড বন্ধু - ওয়েব প্রোগ্রামিং শেখার সেরা প্ল্যাটফর্ম' }} </title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="canonical" href="{{url()->current()}}">
    <meta name="theme-color" content="#6610f2">
    <meta name="author" content="কোড বন্ধু">
    ...
    <meta name="description" content="কোড বন্ধু - ওয়েব প্রোগ্রামিং শেখার সেরা প্ল্যাটফর্ম। এখানে পাবেন JavaScript, PHP, Python, Laravel, React, Node.js সহ বিভিন্ন ওয়েব ডেভেলপমেন্ট টিপস, নোটস ও টিউটোরিয়াল। ওয়েব প্রোগ্রামিং সহজভাবে শিখুন এবং ক্যারিয়ার গড়ুন!">
    <meta name="robots" content="index, follow">
    <meta name="googlebot" content="index, follow">

    <!-- Open Graph Meta Tags (Facebook, LinkedIn, etc.) -->
    <meta property="og:title" content="{{ isset($meta_title) ? 'কোড বন্ধু - '.$meta_title : 'কোড বন্ধু - ওয়েব প্রোগ্রামিং শেখার সেরা প্ল্যাটফর্ম' }}">
...
{{--    <meta name="twitter:card" content="summary_large_image">--}}
    <meta name="twitter:title" content="{{ isset($meta_title) ? 'কোড বন্ধু - '.$meta_title : 'কোড বন্ধু - ওয়েব প্রোগ্রামিং শেখার সেরা প্ল্যাটফর্ম' }}">
